class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},
Mʏ Nᴀᴍᴇ Is <a href=https://t.me/{}>{}</a>, I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs Iɴ Gʀᴏᴜᴘꜱ Oɴʟʏ. Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ 🎉</b>"""
...
✯ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: v2.7.1 [ Sᴛᴀʙʟᴇ ]</b>"""
    ...
    TELE_TXT = """🔶 <b>Hᴏᴡ Tᴏ Uꜱᴇ :</b>
🔘 Dᴏ ᴀꜱ ʏᴏᴜ ᴡɪꜱʜ ᴡɪᴛʜ telegra.ph ᴍᴏᴅᴜʟᴇ !
✒️ /telegraph - Sᴇɴᴅ ᴍᴇ Pɪᴄᴛᴜʀᴇ ᴏʀ Vɪᴅᴇᴏ. [ Sɪᴢᴇ ᴍᴜꜱᴛ ʙᴇ Uɴᴅᴇʀ 𝟻MB ]
<b>Nᴏᴛᴇ:</b>
• Tʜɪꜱ Cᴏᴍᴍᴀɴᴅ Iꜱ Aᴠᴀɪʟᴀʙʟᴇ ɪɴ Gʀᴏᴜᴘꜱ Aɴᴅ Pᴍ.
• Tʜɪꜱ Cᴏᴍᴍᴀɴᴅ Cᴀɴ Bᴇ Uꜱᴇᴅ Bʏ Eᴠᴇʀʏᴏɴᴇ."""

    FONT_TXT= """🔷 <b>Hᴏᴡ Tᴏ Uꜱᴇ :</b>
 <b>Uꜱᴇ Cᴏᴍᴍᴀɴᴅ</b> : /font Yᴏᴜʀ Tᴇxᴛ"""
...
3. Usᴇ /settings ᴏɴ ʙᴏᴛ's PM ᴀɴᴅ ᴛᴜʀɴ ᴏɴ AᴜᴛᴏFɪʟᴛᴇʀ ᴏɴ ᴛʜᴇ sᴇᴛᴛɪɴɢs ᴍᴇɴᴜ."""
    ...
    CONNECTION_TXT = """ʜᴇʟᴘ: <b>Cᴏɴɴᴇᴄᴛɪᴏɴꜱ</b>
...
Cʜᴇᴄᴋ Yᴏᴜʀ Sᴘᴇʟʟɪɴɢ Bᴇʟᴏᴡ , Iғ Yᴏᴜ Aʀᴇ Sᴇᴀʀᴄʜɪɴɢ Aɴʏᴛʜɪɴɢ Rᴇʟᴀᴛᴇᴅ Tᴏ Tʜᴇꜱᴇ."""

    SPELL_CHECK_ENG_TXT = """Nᴏ Fɪʟᴇꜱ Wᴇʀᴇ Fᴏᴜɴᴅ Fᴏʀ Yᴏᴜʀ Rᴇǫᴜᴇꜱᴛ.
...
• Pᴇʀᴍᴀɴᴇɴᴛ Dᴍ Lɪɴᴋ : <a href='t.me/TEAM_SNS_BOT'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""

    REQINFO = """
⚠ Iɴғᴏʀᴍᴀᴛɪᴏɴ ⚠
----------------
📢 ᴀꜰᴛᴇʀ 10 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴅᴇʟᴇᴛᴇᴅ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ.

🌀 ɪꜰ ʏᴏᴜ 𝙲𝙰𝙽 ɴᴏᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇsᴛᴇᴅ ᴍᴏᴠɪᴇ / sᴇʀɪᴇs ꜰɪʟᴇ, ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ"""
...
🔹 𝐒𝐞𝐚𝐫𝐜𝐡 𝐌𝐨𝐯𝐢𝐞𝐬 𝐖𝐢𝐭𝐡 𝐓𝐡𝐢𝐬 𝐅𝐨𝐫𝐦𝐚𝐭 :
› ᴀᴠᴀᴛᴀʀ ✅
› ᴀᴠᴀᴛᴀʀ 2009 ✅

🔹 𝐒𝐞𝐚𝐫𝐜𝐡 𝐖𝐞𝐛𝐒𝐞𝐫𝐢𝐞𝐬 𝐖𝐢𝐭𝐡 𝐓𝐡𝐢𝐬 𝐅𝐨𝐫𝐦𝐚𝐭: 
› ᴠɪᴋɪɴɢs S01 ✅
› ᴠɪᴋɪɴɢs S01E01 ✅"""
